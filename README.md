...
<img src="https://capsule-render.vercel.app/api?type=rect&color=0:0D1117,100:1F2937&height=160&section=header&text=Ambadas%20Gote&fontSize=28&fontColor=00D4FF&animation=fadeIn&fontAlignY=45&desc=MERN%20Engineer%20•%20Backend%20Architect%20•%20System%20Builder&descSize=14&descAlignY=70"/>
...
const ambadas = {
  ...
  building: "InternStatus — Internship Operating System",
  focus: ["Backend Engineering", "System Design", "Scalable Architecture"],
  mindset: "Design the data model → architect the system → ship clean code",
  strength: "Turning complex requirements into production-ready platforms",
  contact: "ambadasgote7@gmail.com"
};
```

* 💼 Working on real production features that ship
* 🔭 Building a multi-role internship ecosystem (InternStatus)
* 🌱 Currently learning DevOps & system scalability
